...
public class RideDetails implements Serializable{
    ...
    public RideDetails(int id, String name, String gender, String pref_comp, int age, long contact, int hour, int min, int year, int month, int day, double src_lat, double src_lang, double dest_lat, double dest_long, String src_name_x, String dest_name_x, String price,String licenceNumber,String carNumber,String carModel) {
        this.id = id;
        this.name = name;
        this.gender = gender;
