...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String create_table_ride = "CREATE TABLE " + TABLE_RIDE + "(" + key_id + " INTEGER PRIMARY KEY," + key_name
                + " TEXT," + key_gender + " TEXT," + key_pref_comp + " TEXT," + key_age + " INTEGER,"
                + key_contact + " INTEGER," + key_hour + " INTEGER," + key_min + " INTEGER," +
                key_year + " INTEGER," + key_month + " INTEGER," + key_day + " INTEGER," + key_src_lat + " REAL," +
                key_src_long + " REAL," + key_dest_lat + " REAL," + key_dest_long + " REAL," +
                key_src_name + " TEXT," + key_dest_name + " TEXT, "+ key_price+" TEXT, "+key_licence_number+" TEXT, "+key_car_number+" TEXT, "+key_car_model+" TEXT)";
        db.execSQL(create_table_ride);
        Log.d(Const.TAG,"Table created");
    }
    ...
    public void addRide(RideDetails rd) {
        ...
        values.put(key_price, rd.getPrice());
        values.put(key_licence_number, rd.getLicenceNumber());
        values.put(key_car_number, rd.getCarNumber());
        values.put(key_car_model, rd.getCarModel());
    ...
    public RideDetails getRide(int id) {
        ...
        Cursor cursor = db.query(TABLE_RIDE, new String[]{key_id, key_name, key_gender, key_pref_comp, key_age, key_contact, key_hour, key_min, key_year, key_month, key_day, key_src_lat, key_src_long, key_dest_lat, key_dest_long, key_src_name, key_dest_name, key_price, key_licence_number,key_car_number, key_car_model}, key_id + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
        RideDetails rd = new RideDetails(Integer.parseInt(cursor.getString(0)),
                cursor.getString(1), cursor.getString(2), cursor.getString(3),
                Integer.parseInt(cursor.getString(4)), Long.parseLong(cursor.getString(5)),
                ...
                Integer.parseInt(cursor.getString(10)), Double.parseDouble(cursor.getString(11)),
                 Double.parseDouble(cursor.getString(12)), Double.parseDouble(cursor.getString(13)),
                 Double.parseDouble(cursor.getString(14)), cursor.getString(15), cursor.getString(16),
...
//        return null;
    ...
    public List<RideDetails> getAllRides() {
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_RIDE +" ORDER BY "+key_id +" DESC";
            ...
            if (cursor.moveToFirst()) {
                do {
                    RideDetails rd = new RideDetails(Integer.parseInt(cursor.getString(0)),
                            ...
                            cursor.getString(17),cursor.getString(18),cursor.getString(19),cursor.getString(20));
                    // Adding Ride to list
                    Log.d(Const.TAG,"id: "+cursor.getString(0));
                    contactList.add(rd);
...
//        return null;
    ...
    public int getRowCount(){
        String selectQuery = "SELECT * FROM " + TABLE_RIDE +" ORDER BY "+key_id+ " ";
